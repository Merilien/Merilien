...
public class Main {
    public static void main(String[] args) {
        ...
        int ammo = (int) (Math.random() * 5001);
        Carrier myCarrier = new Carrier(ammo);

        int f16Count = (int) (Math.random() * 21) + 1;
        int f35Count = (int) (Math.random() * 11) + 1;
        ...
        ammo = (int) (Math.random() * 5001);
        Carrier enemyCarrier = new Carrier(ammo);

        f16Count = (int) (Math.random() * 21) + 1;
        f35Count = (int) (Math.random() * 11) + 1;
        for (int i = 0; i < f16Count; i++) {
